...
\begin{xltabular}{\linewidth}{L|L|L|L|L}
    ...
    \Xhline{1pt}
\multicolumn{5}{|c|}{Início da tabela longa}\\
    \hline
...
\endfoot
     \hline
     \multicolumn{5}{|c|}{Final da tabela longa}\\
     \Xhline{1pt}
\endlastfoot
%%%% table body
...
\begin{longquadro}{\linewidth}{|*{5}{L|}}
    ...
    \Xhline{1pt}
\multicolumn{5}{|c|}{Início do quadro longo}\\
    \hline
\textbf{Chave} & \textbf{Nome}   & \textbf{Tarefa/Banda} & \textbf{Análise} & \textbf{Contexto}\\
    \Xhline{0.5pt}
\endfirsthead
...
\endfoot
     \hline
     \multicolumn{5}{|c|}{Final do quadro longo}\\
     \Xhline{1pt}
\endlastfoot
%%%% table body
\lipsum[56] & \lipsum[56] & \lipsum[56] & \lipsum[56] & \lipsum[56] \\ \hline
